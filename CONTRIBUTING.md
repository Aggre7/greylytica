...
Welcome to the [greylytica-erp](<[greylytica-erp](https://github.com/Aggre7/greylytica)>) repository! We're excited that you're interested in contributing. Please take a moment to review this document to ensure a smooth collaboration process.
...
- please make sure it was not asked before here [issues](https://github.com/Aggre7/greylytica/issues).
- make sure it is not work in progress here [pull requests](https://github.com/Aggre7/greylytica/pulls).
- you can then [create an issue](https://github.com/Aggre7/greylytica/choose) with the following information:
...
Thank you for contributing to [greylytica](https://github.com/Aggre7/greylytica) dont forget to give us a :star: !
