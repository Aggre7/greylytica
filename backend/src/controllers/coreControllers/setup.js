...
const setup = async (req, res) => {
  ...
  for (const filePath of settingsFiles) {
    ...
    const settingsToUpdate = {
      greylytica_app_email: email,
      greylytica_app_company_email: email,
      greylytica_app_timezone: timezone,
      greylytica_app_country: country,
      greylytica_app_language: language || 'en_us',
    };
  ...
  return res.status(200).json({
    success: true,
    result: {},
    message: 'Successfully greylytica App Setup',
  });
};
